...
{
    [TestClass]
    public class HtmlHeaderWithImageUrlPdfReport
    {
        [TestMethod]
        public void Verify_HtmlHeaderWithImageUrlPdfReport_Can_Be_Created()
        {
            var report = CreateHtmlHeaderWithImageUrlPdfReport();
            TestUtils.VerifyPdfFileIsReadable(report.FileName);
        }

        public IPdfReportData CreateHtmlHeaderWithImageUrlPdfReport()
        {
             ...
             .PagesHeader(header =>
             {
                 header.HtmlHeader(rptHeader =>
                 {
                     ...
                     rptHeader.AddPageHeader(pageHeader =>
                     {
                         ...
                         var imageUrl = "<img src='https://raw.githubusercontent.com/VahidN/PdfReport.Core/master/src/PdfRpt.Core.FunctionalTests/Images/01.png' />";
